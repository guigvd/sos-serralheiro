...
import { calcularJanela2FolhasGold } from '@/lib/planos/gold/janela2Folhas'
import type { ResultadoPlano } from '@/lib/planos/suprema/janela2Folhas'

export default function Janela2FolhasGold() {
  ...
  function calcular() {
    ...
    setErro('')
    setResultado(calcularJanela2FolhasGold(l, a))
  }

  return (
    <div className="space-y-6 max-w-3xl mx-auto">
      <div>
        <p className="text-xs text-[#6b7280] mb-1">Linha Gold</p>
        ...
        <div className="space-y-4">
          <div className="overflow-hidden rounded-lg border border-[#2a2a2a]">
            <div className="border-b border-[#2a2a2a] bg-[#1c1c1c] px-5 py-3">
              <h2 className="text-sm font-medium text-[#f5f5f5]">Perfis de alumínio</h2>
            </div>
                ...
                <tbody className="divide-y divide-[#2a2a2a] bg-[#1c1c1c]">
                  {resultado.perfis.map((p, i) => (
                    <tr key={i} className="transition-colors hover:bg-[#2a2a2a]">
                      ...
                      <td className="px-5 py-3 text-right font-mono text-[#f5f5f5]">{p.tamanho} mm</td>
